...
public class popup_pelanggan extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Cari ID/Nama Pelanggan : ");
    ...
    private void tbl_pelangganMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tbl_pelangganMouseClicked
        ...
        pelanggan.id_pelanggan = tbl_pelanggan.getValueAt(tabelpelanggan, 0).toString();
        pelanggan.nama_pelanggan = tbl_pelanggan.getValueAt(tabelpelanggan, 1).toString();
        pelanggan.no_telpon = tbl_pelanggan.getValueAt(tabelpelanggan, 2).toString();
        pelanggan.alamat = tbl_pelanggan.getValueAt(tabelpelanggan, 3).toString();
